...
export const authConfig: Auth = {
  ...
  methods: {
    ...
    // NOTE: Google and GitHub were enabled in the pre-migration app. Re-enable them
    // once GOOGLE_CLIENT_ID/SECRET and GITHUB_CLIENT_ID/SECRET are set in .env.server.
